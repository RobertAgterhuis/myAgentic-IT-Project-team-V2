...
> Stack: teams | Status: DEFERRED | Applicable: PENDING
...
| ----------- | -------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| DEC-CAT-501 | HIGH     | Phase 2 (Bot Framework)       | Use Teams Toolkit / Teams AI Library for new Teams apps; Bot Framework SDK v4 for existing bots; no direct REST API calls to Bot Connector | Teams Toolkit is the current recommended approach for new Teams apps (2025+). Existing Bot Framework v4 apps continue on SDK v4. Teams AI Library preferred for AI-powered agents. | 2026-03-16 |
