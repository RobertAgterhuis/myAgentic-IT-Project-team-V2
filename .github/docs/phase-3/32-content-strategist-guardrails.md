...
> **Date:** 2026-03-10  
> **Based on analysis:** `.github/docs/phase-3/32-content-strategist-analysis.md`
...
### Rule
Content Strategist outputs must contain frameworks, patterns, and illustrative examples only. Final product copy is prohibited.

### Violation Action
Mark `GUARDRAIL_VIOLATION: G-CS-001`; reject deliverable and require rewrite.

### Rationale
Maintains contract boundaries and avoids premature copy lock before brand/localization phases.

### Verification Method
Manual review for final-sounding slogans, definitive UI labels, or campaign claims.
...
### Rule
Every core product concept must have one canonical term; synonym swapping in workflow-critical labels is prohibited.

### Violation Action
Mark `GUARDRAIL_VIOLATION: G-CS-002`; block content approval until glossary alignment is complete.
...
### Rule
All error frameworks must include both issue description and corrective next action; generic failure text without recovery guidance is prohibited.
...
### Rule
Content frameworks must define readability thresholds and acronym/jargon policies; unexplained acronyms in user-facing guidance are prohibited.
...
### Scope
- Applies to: handoff from Content Strategist (32) to Localization Specialist (35)
- Time horizon: Phase 3 completion

### Rule
Localization work may not start until style guide, glossary, content map, and tone framework are versioned and handed off.
...
### Rule
Content frameworks must be reviewed for consistency with Accessibility Specialist requirements before final approval.

### Violation Action
Mark `GUARDRAIL_VIOLATION: G-CS-006`; hold approval until accessibility review completed.

### Rationale
Prevents conflicts between clarity guidance and WCAG-aligned communication requirements.

### Verification Method
Cross-review signoff by Accessibility Specialist (13) in content review workflow.
