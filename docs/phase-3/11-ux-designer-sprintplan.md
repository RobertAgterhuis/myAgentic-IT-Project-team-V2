...
1. `docs/brand/design-tokens.json` exists with color, typography,
...
3. 30+ components documented in `docs/storybook/component-inventory.md`:
...
4. **Actions:**
   ...
   - Save → POST /api/decisions → write to `docs/decisions.md` → SSE
...
- [ ] Timeline renders decisions from `docs/decisions.md`
...
- Synthesis Agent (Agent 17) must have run (produces `docs/synthesis/`
  files)
...
1. **Animation Tokens (UI Designer):**
   - File: `docs/brand/animation-tokens.json`
...
1. **Gesture Specs (UI Designer):**
   - Document: `docs/brand/gesture-design.md`
...
- [x] Deliverable written to file
      `docs/phase-3/11-ux-designer-sprintplan.md`
...
- UX Designer Analysis: `docs/phase-3/11-ux-designer-analysis.md`
  (wireframes, gaps, risks)
- UX Designer Recommendations:
  `docs/phase-3/11-ux-designer-recommendations.md`
- UX Researcher Sprint Plan:
  `docs/phase-3/10-ux-researcher-sprintplan.md` (sprint structure)
- Contracts: `docs/contracts/sprintplan-output-contract.md`
