...
### Rule
A sprint commitment must not be approved unless each P1/P2 recommendation is mapped to an owner, dependency set, and readiness status.
### Violation Action
...
- Time horizon: Permanent
### Rule
Items marked P1/P2 must always pass DoR (owner, acceptance criteria, split feasibility, blockers) before implementation scheduling.
### Violation Action
...
### Rule
External-facing feature proposals must not enter active roadmap without a logged scope decision.
### Violation Action
...
```json
{
  ...
  "guardrails": [
    {"id":"G-PM-3401","analysis_reference":["GAP-3401"],"priority":"Critical"},
    {"id":"G-PM-3402","analysis_reference":["GAP-3402","RISK-3402"],"priority":"Critical"},
    {"id":"G-PM-3403","analysis_reference":["RISK-3401"],"priority":"High"}
  ],
  "handoff_checklist": {
    "all_testable": true,
