...
- Source: `.github/docs/phase-2/05-software-architect-analysis.md:507`, route
  pipeline inspection
- Impact: High
...
- Source: `.github/docs/phase-2/07-devops-engineer-analysis.md` (`GAP-706`,
  `RISK-705`)
- Impact: High
...
- Source: `.github/docs/phase-2/05-software-architect-analysis.md:508`, route
  inspection
...
- Source: `.github/docs/phase-2/06-senior-developer-analysis.md`
  (`INSUFFICIENT_DATA: security testing tool choice`),
  `.github/docs/phase-2/07-devops-engineer-analysis.md` (`IND-701`)
