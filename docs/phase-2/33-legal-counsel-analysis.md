...
- Source: `docs/phase-2/08-security-architect-analysis.md` (`GAP-805`),
  `docs/phase-2/09-data-architect-analysis.md` (`IND-902`)
- Impact: High
...
- Source: GDPR Art. 5, Art. 25;
  `docs/phase-2/08-security-architect-analysis.md`
- Impact: Medium
...
- Source: GDPR Art. 6; `docs/phase-2/09-data-architect-analysis.md`
  (`IND-901`)
- Impact: High
...
- Source: GDPR Art. 35; `QR-003`;
  `docs/phase-2/08-security-architect-analysis.md` (`UNC-801`)
- Impact: Medium
...
- Source: `docs/phase-2/09-data-architect-analysis.md` (`IND-902`)
- Impact: High
...
- Source: GDPR Art. 6, 13, 14 +
  `docs/phase-2/09-data-architect-analysis.md`
...
- Source: `docs/phase-2/07-devops-engineer-analysis.md` (future
...
- Mitigation options: define retention matrix and enforce through operational
  controls.
- Source: `GAP-3304`, `docs/phase-2/09-data-architect-analysis.md`
...
- Source: `GAP-3303`, `docs/phase-2/05-software-architect-analysis.md`
...
- Source: `docs/phase-2/08-security-architect-analysis.md`,
  `docs/phase-2/09-data-architect-analysis.md`
