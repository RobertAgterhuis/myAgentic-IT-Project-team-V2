...
1. Software Architect (05) — `docs/phase-2/05-software-architect-*.md`
2. Senior Developer (06) — `docs/phase-2/06-senior-developer-*.md`
3. DevOps Engineer (07) — `docs/phase-2/07-devops-engineer-*.md`
4. Security Architect (08) — `docs/phase-2/08-security-architect-*.md`
5. Data Architect (09) — `docs/phase-2/09-data-architect-*.md`
6. Legal Counsel (33) — `docs/phase-2/33-legal-counsel-*.md`
...
- **Source:** `docs/phase-2/05-software-architect-analysis.md`
  ...
  `docs/phase-2/08-security-architect-analysis.md` (UNCERTAIN: future
  deployment timeline)
...
- **Source:** `docs/phase-2/08-security-architect-analysis.md` (Section
  6), `docs/phase-2/09-data-architect-analysis.md` (Section 6),
  `docs/phase-2/33-legal-counsel-analysis.md` (Section 6)
...
- **Source:** `docs/phase-2/07-devops-engineer-analysis.md`
  (INSUFFICIENT_DATA: security gate severity policy),
  `docs/phase-2/08-security-architect-analysis.md` (INSUFFICIENT_DATA:
  security gate severities)
...
- **Source:** `docs/phase-2/09-data-architect-analysis.md` (Section 6),
  `docs/phase-2/33-legal-counsel-analysis.md` (Section 6)
...
- **Source:** `docs/phase-2/06-senior-developer-analysis.md` (Section
  1.3, KPI baseline)
...
- [x] docs/decisions.md loaded and DECIDED items processed as
      constraints
...
1. **IMMEDIATE:** Update `session-state.json`:
   ...
   - `phase_outputs.phase-2.critic_risk: "docs/phase-2/critic-risk-validation.md"`
