...
export const mockOrchestratorPackMetadata: OrchestratorPackMetadataResponse = {
  ...
  commands: [
    ...
    { id: 'CREATE BUSINESS', label: 'CREATE BUSINESS', mode: true },
    { id: 'CREATE TECH', label: 'CREATE TECH', mode: true },
    { id: 'CREATE UX', label: 'CREATE UX', mode: true },
    { id: 'CREATE MARKETING', label: 'CREATE MARKETING', mode: true },
    { id: 'AUDIT', label: 'AUDIT', mode: true },
    { id: 'FEATURE', label: 'FEATURE', mode: true },
    { id: 'SCOPE CHANGE', label: 'SCOPE CHANGE', mode: true },
    { id: 'HOTFIX', label: 'HOTFIX', mode: true },
    { id: 'AGENCY ONLY', label: 'AGENCY ONLY', mode: true },
    { id: 'HYBRID', label: 'HYBRID', mode: true },
