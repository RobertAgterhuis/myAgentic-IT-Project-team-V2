...
Existing social cards (`social-cards/`) already contain platform branding.
Add Dev.to profile URL to the `README.md` Community section:
...
Example: `https://[LANDING_URL]?utm_source=devto&utm_medium=blog&utm_campaign=sprint-3-crosspost&utm_content=multi-agent-sdlc`
