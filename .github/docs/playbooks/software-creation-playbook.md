...
1. **Brand & Assets Agent** (skill: `30-brand-assets-agent.md`) — design
   tokens + brand assets (`.github/docs/brand/`)
2. **Storybook Agent** (skill: `31-storybook-agent.md`) — component library +
   a11y baseline (`.github/docs/storybook/`)
...
- `.github/docs/session/github-state-snapshot.json` (captured at Sprint Gate
  Step 0)
...
update Output: `.github/docs/synthesis/scope-change-[N].md` + updated sprint
statuses
