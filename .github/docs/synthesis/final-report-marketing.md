...
Primary sources: `.github/docs/phase-4/*`,
...
- Phase 4 overall critic verdict is approved
  (`.github/docs/phase-4/critic-risk-validation.md:414`).
- Risk inventory is complete with no critical unmitigated risk and three
  high-priority items (`.github/docs/phase-4/critic-risk-validation.md:562`).
- Growth and CRO plans include measurable funnels, sample-size discipline, and
  escalation gates (`.github/docs/phase-4/16-cro-specialist-guardrails.md`,
...
- Brand assets and storybook baselines are now available for downstream
  implementation consistency (`.github/docs/brand/brand-assets-report.md`,
