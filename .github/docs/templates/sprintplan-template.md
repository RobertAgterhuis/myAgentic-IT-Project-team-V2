...
> `.github/docs/contracts/sprintplan-output-contract.md` for the full
> requirements.
...
> create a fictitious plan.

- **Team composition:** [roles + number of people – e.g. "2 backend developers,
  1 designer"]
- **Sprint duration:** [N weeks – default 2 weeks]
- **Capacity per sprint:** [story points or hours – e.g. "40 story points per
  sprint"]
...
**Assumption status:** Fully available / Partially available (INSUFFICIENT_DATA:
[items]) / Not available (HALT)
...
[Describe the concrete result that is visible to a user or stakeholder after
this sprint]
...
> **Acceptance criteria format:** "Given [context], when [action], then
> [expected result]"
