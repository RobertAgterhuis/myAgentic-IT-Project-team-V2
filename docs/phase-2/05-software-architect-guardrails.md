...
MUST have a corresponding ADR in `docs/architecture/` before
implementation.
...
- [ ] If architecture decision made: ADR-XXX created in `docs/architecture/`
...
- Document in `docs/legal/license-exemptions.md` with rationale
...
`docs/violations/YYYY-MM-DD-[guardrail-id].md`:
