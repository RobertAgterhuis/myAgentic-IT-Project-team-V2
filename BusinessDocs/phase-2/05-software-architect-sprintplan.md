...
- ADR-007 exists in `docs/architecture/`
...
`docs/architecture/` so that decisions are discoverable and searchable.

**Acceptance Criteria:**

- [ ] Directory `docs/architecture/` created
...
- [ ] ADR template created in `docs/architecture/ADR-TEMPLATE.md`:
  - Sections: Title, Status, Context, Decision, Consequences, Source, Date
- [ ] ADR index created in `docs/architecture/README.md`:
