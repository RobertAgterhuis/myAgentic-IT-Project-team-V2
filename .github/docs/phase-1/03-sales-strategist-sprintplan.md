...
- Phase: 1
- Based on recommendations: `.github/docs/phase-1/03-sales-strategist-recommendations.md`
- Date: 2026-03-09
...
```json
{
  ...
  "assumptions": {
    "teams": [
      ...
      {"name":"Team Strategy","roles":["Product/Domain/Sales"],"capacity_per_sprint":"6 SP"}
    ],
