...
This is the authoritative GA governance artifact for the solution. Public-facing
documentation may summarize this document, but SDLC decisions, release gates,
and audit alignment must reference this file.
...
| G7  | Privacy model documented                        | `docs/security/data-inventory.md` + `docs/operations/privacy-policy.md` exist | Files exist and reviewed                                |
...
- [ ] Verify `src/webapp/server.ts` starts without errors
