...
- Input received from: `docs/phase-3/10-ux-researcher-analysis.md` +
...
- **How:** Check `docs/phase-3/persona-validation-report.md` exists AND
...
- **Automated:** Parse `docs/phase-3/persona-validation-report.md` for
  validation count
...
- **Report:** `docs/phase-3/ia-validation-report.md` documents success
  rate
