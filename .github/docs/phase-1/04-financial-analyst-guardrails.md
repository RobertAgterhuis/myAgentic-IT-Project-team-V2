...
### Rule
Monthly sprint/program reporting must always include labor-burn baseline and variance; reports without it are invalid.
### Violation Action
...
- Time horizon: Permanent
### Rule
Any claim of efficiency or cost improvement must reference a current monthly KPI report; unverifiable claims must be tagged `UNCERTAIN:`.
### Violation Action
...
### Rule
If external adoption intent changes, commercialization trigger model must be updated before roadmap reprioritization.
### Violation Action
Mark `GUARDRAIL_VIOLATION: G-FIN-403`, freeze commercialization epics pending update.
### Rationale
...
```json
{
  ...
  "guardrails": [
    {"id":"G-FIN-401","analysis_reference":["GAP-401","RISK-401"],"priority":"Critical"},
    {"id":"G-FIN-402","analysis_reference":["GAP-402","RISK-402"],"priority":"High"},
    {"id":"G-FIN-403","analysis_reference":["GAP-403","RISK-403"],"priority":"Medium"}
  ],
  "handoff_checklist": {
    "all_testable": true,
