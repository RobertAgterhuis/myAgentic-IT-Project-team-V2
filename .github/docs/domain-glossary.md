...
Canonical terminology for workflow states, protocol markers, and orchestration signals used across skills, guardrails, and contracts.
...
- When introducing new protocol markers or statuses, add them here and in related contracts/guardrails.
