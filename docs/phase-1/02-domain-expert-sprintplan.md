...
- Team composition:
  ...
  - Team Domain Review (virtual role): Domain Expert + Product Manager support,
    capacity 6 SP/sprint (analytical tasks)
- Sprint duration: 2 weeks
- Technology stack: Node.js-based repository workflow, Markdown/JSON governance
  artifacts
- Prerequisites:
...
Create objective market/competition/governance foundations to protect
differentiation.
...
```json
{
  "metadata": {
    ...
    "phase": "1",
    "date": "2026-03-09",
    "based_on_recommendations": "docs/phase-1/02-domain-expert-recommendations.md",
    "total_sprints": 2,
    "mode": "CREATE"
  },
  "assumptions": {
    "teams": [
      ...
      {
        "name": "Team Domain Review",
        "roles": ["Domain Expert", "Product Manager"],
