...
**Analysis** deliverable of every agent. An analysis that does not comply with
this contract is **returned** by the Critic Agent.

---

## Output File Path

`docs/phases/phase-N-[discipline]-analysis.md`

Where `N` is the phase number (1–4) and `[discipline]` is the lowercase
discipline name (e.g., `phase-1-business-analysis.md`).
...
- [Finding ID from prior analysis]: [one sentence why still applicable under the
  new premise]

### Superseded

- [Finding ID from prior analysis]: [what changed and why no longer applicable
  under the new premise]
...
- `INSUFFICIENT_DATA: [section/field]` – Missing: [what] – Consequence: [impact
  on analysis]
