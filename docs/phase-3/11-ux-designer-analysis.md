...
│ [Feedback]         │    - Check for stale .lock files in docs/      │
│                    │                                                        │
...
- Phase 1 outputs: `docs/phase-1/01-business-analyst-analysis.md` (ICP),
  `docs/phase-1/34-product-manager-analysis.md` (MVP scope)
- Phase 2 outputs: `docs/phase-2/05-software-architect-analysis.md` (UI
  screen list), `docs/phase-2/06-senior-developer-analysis.md`
  (WebSocket real-time)
- UX Researcher: `docs/phase-3/10-ux-researcher-analysis.md` (personas,
  journey, gaps, risks)
- Contracts: `docs/contracts/analysis-output-contract.md`
