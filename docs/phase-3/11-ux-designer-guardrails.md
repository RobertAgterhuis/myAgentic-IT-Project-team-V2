...
documented in `docs/storybook/component-inventory.md`. All UI elements
...
`docs/storybook/component-inventory.md` MUST be updated BEFORE
...
- [x] Deliverable written to file
      `docs/phase-3/11-ux-designer-guardrails.md`
...
- Phase 2: `docs/phase-2/08-security-architect-analysis.md` (secret
  detection requirements)
- Contracts: `docs/contracts/guardrails-output-contract.md`
- Guardrails: `docs/guardrails/04-ux-guardrails.md`,
  `docs/guardrails/00-global-guardrails.md`,
  `docs/guardrails/09-questionnaire-guardrails.md` (G-QUEST-20)
