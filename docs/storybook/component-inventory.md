...
- Design tokens source: `docs/brand/design-tokens.json`
- Brand guidelines source: `docs/brand/brand-guidelines.md`
...
- Category: ATOM
- Description: Core action control for primary, secondary, and destructive
  actions.
- Props / Variants:
...
- Design Token References:
  - `colors.primary`, `colors.secondary`, `colors.accent`, `colors.error`,
    `colors.textInverse`
  - `typography.fontFamilies.body`, `typography.fontSizes.sm`,
...
- Design Token References:
  - `colors.surface`, `colors.text`, `colors.border`, `colors.focusRing`,
    `colors.error`
...
- Category: MOLECULE
- Description: Structured content container for recommendations, risks, and
  sprint stories.
- Props / Variants:
...
- Design Token References:
  ...
  - `spacing.scale.4`, `spacing.scale.6`, `borders.radius.lg`, `shadows.sm`,
    `shadows.md`
- Accessibility Requirements:
...
- Category: MOLECULE
- Description: Inline notification for success, warning, error, and
...
- Category: MOLECULE
- Description: Label, helper, input/control, and validation block used in all
  forms.
- Props / Variants:
...
- Category: ORGANISM
- Description: Global navigation shell with project context, search, and primary
  actions.
- Props / Variants:
...
- Category: ORGANISM
- Description: Left navigation panel for phase and agent context with progress
  indicators.
- Props / Variants:
...
- Props / Variants:
  ...
  - `title`, `body`, `actions`
- Design Token References:
  - `colors.surface`, `colors.text`, `colors.border`, `shadows.lg`,
    `borders.radius.xl`
...
- Category: TEMPLATE
- Description: Two-column planning layout for backlog and active sprint
  execution.
- Props / Variants:
  - `filters`, `backlogItems`, `sprintItems`, `metrics`
- Design Token References:
  - `colors.background`, `colors.surface`, `colors.border`, `colors.text`
  - `spacing.scale.4`, `spacing.scale.6`, `breakpoints.tablet`,
    `breakpoints.desktop`
- Accessibility Requirements:
...
- Category: PAGE
- Description: Full page composition for risk inventory, severity matrix, and
  mitigation actions.
- Props / Variants:
  - `riskItems`, `filters`, `summaryCards`, `selectedRisk`
- Design Token References:
  - Full token system including `colors`, `typography`, `spacing`, `borders`,
    `shadows`, `breakpoints`
- Accessibility Requirements:
...
- Deviations require explicit written justification in PR description and
  reviewer approval.
- All components must consume design tokens from
  `docs/brand/design-tokens.json`; hardcoded visual values are
  prohibited.
- Accessibility requirements in this inventory are mandatory release criteria,
  not optional enhancements.
- Component naming convention: `PascalCase` for component names and `camelCase`
  for props.

## 4. Handoff Checklist

- [x] Header includes date and source references
- [x] Component catalog includes category, description, variants/props, token
      references, a11y requirements, and states
