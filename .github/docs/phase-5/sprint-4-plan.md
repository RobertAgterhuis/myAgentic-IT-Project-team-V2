...
> **Treat GA as a governance milestone, not a feature milestone.**
> Close the control-plane gaps before expanding autonomy claims.
> — GA Audit Report, Executive Summary

Sprint 4 targets Audit Waves 1 and 2: define the GA scope, close security/privacy design gaps, align evidence with reality, establish release discipline, and produce operator-ready documentation. No new feature work. Every item directly resolves or advances an audit finding.
...
|------|-------|-----|-------------|
| SP-4-GA-DEF | #137 | 8 | `.github/docs/ga-definition.md` |
...
**Theme:** Close the two remaining CRITICAL audit findings using the deployment profile from Day 1.

| Item | Issue | ACs | Deliverables |
|------|-------|-----|-------------|
| SP-4-SEC | #138 | 8 | `.github/docs/security-design.md` |
| SP-4-PRIV | #139 | 8 | `.github/docs/data-inventory.md`, `docs/privacy-policy.md` |

**SP-4-SEC deliverables:**
- 3-tier deployment profiles (localhost / team / exposed) with security reqs per tier
...
- Reword "autonomous sprint-by-sprint implementation" → supervised/assisted framing
...
- Fix test count badge: 363 (Jest) + 780 (Vitest) = 1143 total (after fixing contrast.test.js)
- Fix Technology Stack table: Root = Jest 29 + ESLint 8; .github/ = Vitest 4 + ESLint 10
...
**SP-4-PR (F-08) work:**
- Create `.github/PULL_REQUEST_TEMPLATE.md` with description, issue refs, test results, checklist
...
| Item | Issue | ACs | Deliverables |
|------|-------|-----|-------------|
| SP-4-DOCS | #144 | 6 | `docs/quick-start.md`, `.github/docs/operating-handbook.md`, doc index |

**SP-4-DOCS (F-12) work:**
- Operator Quick Start guide: clone → install → first run → first CREATE in under 5 mins
...
**Sprint 4 directly addresses:** 8 of 12 findings (3 CRITICAL + 3 HIGH + 2 MEDIUM)
**Deferred to Sprint 5+:** F-06, F-09, F-11 (all require feature implementation, not governance)
**Already addressed:** F-10 (Sprint 3 closed pilot items)
...
1. All 3 CRITICAL findings (F-01, F-02, F-03) have governance documents committed
...
*Sprint plan created: 2026-03-12*
*Source: GA Audit Response (`.github/docs/phase-5/ga-audit-response.md`)*
*Audit report: `word/transformed_doc/myAgentic-IT-Project-team-V2_GA_Audit_Report_2026-03-12.md`*
