...
- `BusinessDocs/` — Project brief, questionnaires, and official documents
  generated by agents
- `BusinessDocs/session/` — Session state, command queue, reevaluation triggers
- `BusinessDocs/synthesis/` — Final reports and blocker matrix
- `BusinessDocs/brand/` — Solution brand output (populated by agents)
- `src/webapp/brand/` — Platform's own design tokens and brand guidelines
