...
> `.github/docs/contracts/guardrails-output-contract.md` for the full
> requirements.
...
> ⚠️ REMINDER: A guardrail is a TESTABLE, BINDING decision rule. Formulate as a
> prohibition or obligation. Start with a verb. Every guardrail MUST have a
> violation action and verification method.
>
> INVALID: "Ensure good code quality" VALID: "Code must not be merged without
> code review by a senior (G-DISC-001)"
...
[E.g.: "Must not be merged" / "Must always contain" / "Requires approval from" /
...
2. [Concrete follow-up action – e.g. "Block handoff", "Escalate to
   Orchestrator", "Revert the change"]
3. [Remediation step]
...
**Based on:** [RISK-NNN] / [GAP-NNN] / [CS-NNN] [Description: what risk or gap
justifies this guardrail?]

### Verification Method

> How do you verify whether an artifact complies with this guardrail?

[E.g.: "Automated test in CI pipeline", "Checklist item in code review", "Manual
audit at sprint review", "Automated linting rule"]
...
- [ ] All guardrails are formulated testably (start with verb, concrete
      condition)
