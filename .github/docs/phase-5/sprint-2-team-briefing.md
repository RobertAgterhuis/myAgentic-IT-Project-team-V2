...
1. **CI Pipeline Completion** — Verify CI Jobs 1-7 on `main`, implement Job 8 (accessibility gate)
2. **Analytics Infrastructure** — Deploy Matomo (privacy-first analytics)
3. **Business Validation** — Internal pilot + feedback rubric
4. **Marketing Launch** — Landing page, email (Buttondown), social content publication
...
- **Reports:** Daily summary → `.github/docs/phase-5/sprint-2-day-{N}-summary.md`
