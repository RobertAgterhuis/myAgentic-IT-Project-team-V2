...
**Issue:** [#131](https://github.com/RobertAgterhuis/myAgentic-IT-Project-team-V2/issues/131)  
**Priority:** P0 BLOCKER  
...
- Added `Access-Control-Allow-Origin "*" always` to static assets block (for `matomo.js`)
