...
- Phase: 1
- Date: 2026-03-09
- Based on analysis: `docs/phase-1/02-domain-expert-analysis.md`
- Mode: CREATE
...
Roadmap epics must always reference at least one documented differentiation
capability; parity-only epics may not exceed 50% of the active sprint scope.

### Violation Action

Mark `GUARDRAIL_VIOLATION: G-DOM-201`, block epic approval, escalate to
Orchestrator.
...
Files containing runtime/session/questionnaire data must be classified
(Public/Internal/Sensitive) before release; unclassified files may not be
merged.
...
No process policy may be marked FINAL for team rollout until at least one
multi-user internal pilot is executed and findings reviewed.
...
```json
{
  "metadata": {
    ...
    "phase": "1",
    "date": "2026-03-09",
    "based_on_analysis": "docs/phase-1/02-domain-expert-analysis.md",
    "mode": "CREATE"
  },
  "guardrails": [
    {
      "id": "G-DOM-201",
      "title": "Differentiation Integrity Guardrail",
      "analysis_reference": ["RISK-201"],
      "priority": "Critical"
    },
    {
      "id": "G-DOM-202",
      "title": "Operational Data Classification Required",
      "analysis_reference": ["GAP-203", "RISK-202"],
      "priority": "High"
    },
    {
      "id": "G-DOM-203",
      "title": "Pilot Before Team-Scale Policy Freeze",
