...
- Source: workspace scan (`docs/contracts/*`,
  `docs/guardrails/*`)
- Impact: Medium
...
- Source: `docs/phase-2/05-software-architect-analysis.md` (LCHECK
  items)
- Impact: Medium
...
- Source: `docs/phase-2/05-software-architect-recommendations.md`
- Impact: Medium

- Finding: Security testing toolchain (SAST/DAST) has not been selected and
  requires Security Architect dependency closure.
- Source: `docs/phase-2/05-software-architect-analysis.md` (DEPENDENT_ON
  Security Architect)
- Impact: High
...
- Description: No dedicated Senior Developer coding standards artifact covering
  ...
  checklist.
- Source: absence in `docs/phase-2/` plus baseline findings in section
  1.2
...
- Source: `package.json`,
  `docs/phase-2/05-software-architect-analysis.md` (LCHECK dependencies)
...
- Source: `docs/phase-2/05-software-architect-analysis.md` (Security
  dependency), GAP-603
