...
> Stack: exchange | Status: DEFERRED | Applicable: NO
> Deferred-Reason: No Exchange Online, EWS, or mail-related Graph API usage
> detected. Activate when email/calendar integration is introduced.
> GitHub Issue: #29
